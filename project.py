...
for line in train_data.values:
    ...
    X_data.append((line[0], baseX[0], baseX[1], baseX[2], baseX[3], baseX[4], baseX[5]))
    ...
    Y_data.append((line[1], line[2], line[5], line[6], line[9], line[10], b1_b2, b1_b3, b2_b3, Ox, Oy, distance, angle_b1, angle_b2, angle_b3))
...
for i in range(START_DEGREE, FINAL_DEGREE):
    ...
    model = make_pipeline(RandomForestRegressor(n_estimators=100))
    # model = make_pipeline(KNeighborsRegressor(n_neighbors=10))
