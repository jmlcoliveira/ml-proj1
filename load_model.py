...
for line in X_test.values:
    ...
    arr.append([line[1], line[2], line[3], line[4], line[5], line[6], line[7], b1_b2, b1_b3, b2_b3, Ox, Oy, angle_b1, angle_b2, angle_b3])
...
if USE_SCALLER:
    result_all = loaded_y_scaler.inverse_transform(result_all)
