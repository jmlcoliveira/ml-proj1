...
NR_TEST_SAMPLES = 257
arr=[]
X_train = pd.read_csv("X_train_single.csv")
path = "models/models-2023-10-15_20-23-18"
loaded_model = pickle.load(open(f'{path}/model_3.plt', 'rb'))
...
for line in X_train.values:
    ...
    arr.append([line[0], line[1], line[2], line[5], line[6], line[9], line[10]])
